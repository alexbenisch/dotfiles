...
export TMUX_POWERLINE_SEG_MAILCOUNT_MBOX_INBOX="/var/spool/mail/alex"
...
TMUX_POWERLINE_SEG_WEATHER_LAT="49.42657411922525"
TMUX_POWERLINE_SEG_WEATHER_LON="8.644052378295736"
# }
